...
define('controllers/register',["./cmodule", "json!cities"], function(cmodule, cities) {
  var RegisterCtrl;
...
define('controllers/findJobs',["./module"], function(module) {
...
define('controllers/craftsmanFindJobs',["./module"], function(module) {
...
define('bootstrap',["ngRoutes", "ngUiRouter", "ngAnimate", "ngCarousel", "ngFileUpload", "ngBootstrap", "ngBootstrapTpls", "angular", "util", "routes", "app", "gmaps", "rateit"], function(_a, _b, _c, _d, _e, _f, _g, ng, _, routes, app) {
