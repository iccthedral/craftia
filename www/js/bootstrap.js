define(["require", "angular", "app", "capi", "moment", "jqueryui", "toastr", "ngBootstrap", "ngBootstrapTpls", "ngRoutes", "ngAnimate", "ngSanitize", "ngFileUpload", "ngTouch", "ngCarousel", "ngUiRouter", "routes"], function(require, ng, app) {
  app.config([
